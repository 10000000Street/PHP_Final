<?php
    ...
    if (isset($_SESSION["encargado"])){
        //$paquete= Logica::pedirTransportistas($_SESSION["encargado"]);
    }
...
<body>
    ...
    <div id="page" class="container">
        <div id="header">
            <div id="logo">
                <h1><a href="?logout=1">Encargado: <?php echo $_SESSION["encargado"]->getNombres();?></a></h1>
        ...
        <div id="main">
            <h2><a style="color:white;">Listado-Alta-Baja-Modificacion de Transportistas</a></h2>
		    <div id="banner">
                <div class="limiter">
